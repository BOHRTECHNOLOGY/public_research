...
class QuantumKitchenSinks():
    ...
    Uses quantum circuits to nonlinearly transform classical inputs into random features.
    ...
    def _make_omega(self):
        ...
        if self.distribution == "normal":
            ...
            raise AttributeError("QKS currently only implemented for normal distributions. Use distribution = 'normal'.")
