...
Record = namedtuple('Record', 'problem_num try_num dwave_time dwave_qpu_time qbsolv_time ortools_time sample_percentage dwave_cost qbsolv_cost ortools_cost optimal_cost')
    ...
    for i, problem in enumerate(problem_source, 1):
        for j in range(1, num_tries+1):
            ...
            record = Record(
                ...
                dwave_qpu_time=info['timing']['total_real_time']/10e6,
