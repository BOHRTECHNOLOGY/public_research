...
def maxcut_qaoa(graph, weights, steps=1, rand_seed=None, connection=None, samples=None,
    ...
    if not isinstance(graph, nx.Graph) and isinstance(graph, list):
        ...
        for edge, weight in zip(graph, weights):

            maxcut_graph.add_edge(*edge, weight=weight/total_weight)
...
if __name__ == "__main__":
    # Sample Run:
    # Cutting 0 - 1 - 2 graph!
    inst = maxcut_qaoa([(0, 1), (1, 2), (0, 2)], [1, 4, 4],
